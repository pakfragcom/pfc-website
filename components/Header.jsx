...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-black/50 backdrop-blur-md border-b border-gray-800">
          ...
          <div className="hidden md:block">
            <nav aria-label="Main Navigation">
              <ul className="flex items-center gap-6 text-sm uppercase tracking-wide">
                ...
                <li><a href="/reviews" className="text-gray-300 hover:text-white transition">Reviews</a></li>
              </ul>
            </nav>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="block md:hidden">
              <button
                ...
                className="p-2 rounded-sm text-gray-400 hover:text-white"
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden bg-black/90 backdrop-blur-sm text-white px-6 py-6 space-y-4">
          <a href="/" className="block text-sm uppercase tracking-wide hover:text-gray-300">Home</a>
          <a href="/blog" className="block text-sm uppercase tracking-wide hover:text-gray-300">Blog</a>
          <a href="/reviews" className="block text-sm uppercase tracking-wide hover:text-gray-300">Reviews</a>
          <a href="https://www.facebook.com/groups/pkfragcom" target="_blank" className="block text-sm hover:text-blue-400">Facebook Group</a>
        </div>
      )}
    </header>
  )
