...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 w-full z-50 h-[80px] bg-black/50 backdrop-blur-md border-b border-gray-800 flex items-center px-4 md:px-10">
      <div className="flex justify-between items-center w-full max-w-screen-xl mx-auto">
        ...
        {/* Nav - Center */}
        <nav className="hidden md:flex space-x-10 text-sm uppercase tracking-wide justify-center">
