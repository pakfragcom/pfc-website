        ...
        <div className="border-b border-white/10 bg-black/40 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <nav className="flex gap-4 text-sm">
              ...
              <Link href="/admin/sellers" className="text-gray-400 hover:text-white transition">Sellers</Link>
            </nav>
          </div>
          <button
            ...
            <>
              ...
              {stats.grace > 0 && (
                <div className="mb-4 rounded-xl bg-yellow-500/10 ring-1 ring-yellow-500/25 px-5 py-4 flex items-center justify-between">
                  ...
                  <Link href="/admin/sellers?filter=grace" className="text-sm text-yellow-300 hover:text-yellow-100 underline underline-offset-2">
                    View
                  </Link>
                </div>
              )}
              ...
              {stats.expiringsoon > 0 && (
                <div className="mb-4 rounded-xl bg-orange-500/10 ring-1 ring-orange-500/25 px-5 py-4 flex items-center justify-between">
                  ...
                  <Link href="/admin/sellers?filter=expiring" className="text-sm text-orange-300 hover:text-orange-100 underline underline-offset-2">
                    View
                  </Link>
                </div>
              )}
              ...
              {stats.pending > 0 && (
                <div className="mb-4 rounded-xl bg-blue-500/10 ring-1 ring-blue-500/25 px-5 py-4 flex items-center justify-between">
                  ...
                  <Link href="/admin/sellers?filter=pending" className="text-sm text-blue-300 hover:text-blue-100 underline underline-offset-2">
                    View
                  </Link>
                </div>
              )}
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  href="/admin/sellers"
                  className="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-medium px-5 py-2.5 rounded-xl transition"
                >
                  Manage Sellers
                </Link>
                <Link
                  href="/admin/sellers?modal=add"
                  className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/15 text-white text-sm font-medium px-5 py-2.5 rounded-xl transition"
                >
                  + Add New Seller
                </Link>
              </div>
